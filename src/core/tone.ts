...
const HYPE: ToneBank = {
  ...
  pr_opened: ['PR is up! nearly there', 'shipped to review. big moment', 'thats a PR. proud of that one'],
...
const DEADPAN: ToneBank = {
  ...
  pr_opened: ['a PR appears.', 'opened. now we wait.', 'review requested. good luck.'],
...
const ZEN: ToneBank = {
  ...
  pr_opened: ['the work is offered to others', 'what is finished must be shown', 'released, and not yet arrived'],
...
const GREMLIN: ToneBank = {
  ...
  pr_opened: ['a PR! someone else problem now', 'thrown over the wall. classic', 'review bait deployed'],
